...
class ToolKit(ToolKitBase):
    ...
    def __init__(self, root_folder: str, token_model: str, global_max_lines: int, permitted_tools: list[str],
                 config: Config) -> None:
    ...
    def report_bool(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(bool, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_bool(
            answer=answer,
            comment=comment
        )
    ...
    def report_dict(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(Any, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_dict(
            answer=answer,
            comment=comment
        )
    ...
    def report_float(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(float, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_float(
            answer=answer,
            comment=comment
        )
    ...
    def report_int(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(int, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_int(
            answer=answer,
            comment=comment
        )
    ...
    def report_json(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(str, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_json(
            answer=answer,
            comment=comment
        )
    ...
    def report_list(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(str, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_list(
            answer=answer,
            comment=comment
        )
    ...
    def report_set(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(list[Any], arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_set(
            answer=answer,
            comment=comment
        )
    ...
    def report_text(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(str, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_text(
            answer=answer,
            comment=comment
        )
    ...
    def report_toml(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(str, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_toml(
            answer=answer,
            comment=comment
        )
    ...
    def report_tuple(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(list[Any], arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_tuple(
            answer=answer,
            comment=comment
        )
    ...
    def report_xml(self, arguments: dict[str, Any]) -> Any:
        ...
        answer = cast(str, arguments.get('answer', ))
        comment = cast(str, arguments.get('comment', ))
        return self.tool_answer_collector.report_xml(
            answer=answer,
            comment=comment
        )
    ...
    def cat(self, arguments: dict[str, Any]) -> Any:
        ...
        file_paths = cast(str, arguments.get('file_paths', ))
    ...
    def cut_characters(self, arguments: dict[str, Any]) -> Any:
        ...
        character_ranges = cast(str, arguments.get('character_ranges', ))
        file_path = cast(str, arguments.get('file_path', ))
        return tool.cut_characters(
    ...
    def cut_fields(self, arguments: dict[str, Any]) -> Any:
        ...
        field_ranges = cast(str, arguments.get('field_ranges', ))
        filename = cast(str, arguments.get('filename', ))
        return tool.cut_fields(
            delimiter=delimiter,
    ...
    def cut_fields_by_name(self, arguments: dict[str, Any]) -> Any:
        ...
        delimiter = cast(str, arguments.get('delimiter', ","))
        field_names = cast(str, arguments.get('field_names', ))
        filename = cast(str, arguments.get('filename', ))
        return tool.cut_fields_by_name(
            delimiter=delimiter,
    ...
    def ed(self, arguments: dict[str, Any]) -> Any:
        ...
        file_name = cast(str, arguments.get('file_name', ))
        script = cast(str, arguments.get('script', ))
        return tool.ed(
            file_name=file_name,
            script=script
        )
    ...
    def find_files(self, arguments: dict[str, Any]) -> Any:
        ...
        file_type = cast(Optional[str], arguments.get('file_type', ))
        name = cast(Optional[str], arguments.get('name', ))
        regex = cast(Optional[str], arguments.get('regex', ))
        size = cast(Optional[str], arguments.get('size', ))
        return tool.find_files(
            file_type=file_type,
            name=name,
            regex=regex,
            size=size
    ...
    def find_files_markdown(self, arguments: dict[str, Any]) -> Any:
        ...
        regex = cast(Optional[str], arguments.get('regex', ))
        size = cast(Optional[str], arguments.get('size', ))
        return tool.find_files_markdown(
            file_type=file_type,
            name=name,
            regex=regex,
            size=size
    ...
    def get_recent_commits(self, arguments: dict[str, Any]) -> Any:
        ...
        return tool.get_recent_commits(
            n=n,
    ...
    def git_diff_commit(self, arguments: dict[str, Any]) -> Any:
        ...
        commit1 = cast(str, arguments.get('commit1', ))
        commit2 = cast(str, arguments.get('commit2', ))
        return tool.git_diff_commit(
            commit1=commit1,
            commit2=commit2
        )
    ...
    def git_log_search(self, arguments: dict[str, Any]) -> Any:
        ...
        search_string = cast(str, arguments.get('search_string', ))
        return tool.git_log_search(
    ...
    def is_ignored_by_gitignore(self, arguments: dict[str, Any]) -> Any:
        ...
        return tool.is_ignored_by_gitignore(
            file_path=file_path,
    ...
    def grep(self, arguments: dict[str, Any]) -> Any:
        ...
        glob_pattern = cast(str, arguments.get('glob_pattern', ))
        ...
        regex = cast(str, arguments.get('regex', ))
    ...
    def head(self, arguments: dict[str, Any]) -> Any:
        ...
        byte_count = cast(Optional[int], arguments.get('byte_count', ))
        file_path = cast(str, arguments.get('file_path', ))
    ...
    def insert_text_after_context(self, arguments: dict[str, Any]) -> Any:
        ...
        file_path = cast(str, arguments.get('file_path', ))
        text_to_insert = cast(str, arguments.get('text_to_insert', ))
        return tool.insert_text_after_context(
            context=context,
            file_path=file_path,
    ...
    def insert_text_after_multiline_context(self, arguments: dict[str, Any]) -> Any:
        ...
        context_lines = cast(str, arguments.get('context_lines', ))
        file_path = cast(str, arguments.get('file_path', ))
        text_to_insert = cast(str, arguments.get('text_to_insert', ))
    ...
    def insert_text_at_start_or_end(self, arguments: dict[str, Any]) -> Any:
        ...
        text_to_insert = cast(str, arguments.get('text_to_insert', ))
        return tool.insert_text_at_start_or_end(
            file_path=file_path,
            position=position,
            text_to_insert=text_to_insert
        )
    ...
    def apply_git_patch(self, arguments: dict[str, Any]) -> Any:
        ...
        patch_content = cast(str, arguments.get('patch_content', ))
        return tool.apply_git_patch(
    ...
    def format_code_as_markdown(self, arguments: dict[str, Any]) -> Any:
        ...
        base_path = cast(str, arguments.get('base_path', ))
        header = cast(str, arguments.get('header', ))
    ...
    def replace_all(self, arguments: dict[str, Any]) -> Any:
        ...
        file_path = cast(str, arguments.get('file_path', ))
        new_text = cast(str, arguments.get('new_text', ))
        old_text = cast(str, arguments.get('old_text', ))
        return tool.replace_all(
            file_path=file_path,
            new_text=new_text,
            old_text=old_text
        )
    ...
    def replace_with_regex(self, arguments: dict[str, Any]) -> Any:
        ...
        file_path = cast(str, arguments.get('file_path', ))
        regex_match_expression = cast(str, arguments.get('regex_match_expression', ))
        replacement = cast(str, arguments.get('replacement', ))
        return tool.replace_with_regex(
            file_path=file_path,
            regex_match_expression=regex_match_expression,
    ...
    def save_if_changed(self, arguments: dict[str, Any]) -> Any:
        ...
        file_path = cast(str, arguments.get('file_path', ))
        final = cast(str, arguments.get('final', ))
        input_text = cast(str, arguments.get('input_text', ))
        return tool.save_if_changed(
            file_path=file_path,
            final=final,
    ...
    def revert_to_latest_backup(self, arguments: dict[str, Any]) -> Any:
        ...
        file_name = cast(str, arguments.get('file_name', ))
        return tool.revert_to_latest_backup(
            file_name=file_name
        )
    ...
    def sed(self, arguments: dict[str, Any]) -> Any:
        ...
        commands = cast(str, arguments.get('commands', ))
        file_path = cast(str, arguments.get('file_path', ))
        return tool.sed(
            commands=commands,
            file_path=file_path
    ...
    def add_todo(self, arguments: dict[str, Any]) -> Any:
        ...
        assignee = cast(Optional[str], arguments.get('assignee', ))
        category = cast(str, arguments.get('category', ))
        description = cast(str, arguments.get('description', ))
        source_code_ref = cast(str, arguments.get('source_code_ref', ))
    ...
    def query_todos_by_regex(self, arguments: dict[str, Any]) -> Any:
        ...
        return tool.query_todos_by_regex(
